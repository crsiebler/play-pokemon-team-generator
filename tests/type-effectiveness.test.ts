...
import { calculateEffectiveness, getSTAB, calculateTotalMultiplier, getEffectivenessCategory } from '../lib/coverage/typeChart';
...
describe('Type Effectiveness Calculator', () => {
  describe('User-Provided Examples', () => {
    ...
    it('should calculate Water vs Dragon/Fire = 1.6×', () => {
      expect(calculateEffectiveness([], ['dragon', 'fire'], 'water')).toBe(1.6);
    });
  ...
  describe('Not Very Effective Interactions (0.625×)', () => {
    ...
    it('Fire should be not very effective vs Dragon', () => {
      expect(calculateEffectiveness([], ['dragon'], 'fire')).toBe(0.625);
    });
  ...
  describe('Dual Type Calculations', () => {
    ...
    it('should calculate SE + Neutral = SE (1.6×)', () => {
      // Water vs Dragon/Fire (1.0 × 1.6)
      expect(calculateEffectiveness([], ['dragon', 'fire'], 'water')).toBe(1.6);
      
      // Fighting vs Normal/Flying (1.6 × 0.625 = 1.0, not 1.6)
      // Actually this should be 1.0, let me correct
    });
    ...
    it('should calculate SE + NVE = Neutral (1.0×)', () => {
      ...
      expect(calculateEffectiveness([], ['normal', 'flying'], 'fighting')).toBe(1.0);
    });
